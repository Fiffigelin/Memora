...
export class Client extends ClientBase {
   ...
   * @return OK
   */
  createVocabularylist(body: CreateVocabularyListDto | undefined): Promise<void> {
    let url_ = this.baseUrl + "/api/VocabularyLists/create-vocabularylist";
    url_ = url_.replace(/[?&]$/, "");
    ...
    return this.transformOptions(options_)
      ...
      .then((_response: Response) => {
        return this.processCreateVocabularylist(_response);
      });
  }

  protected processCreateVocabularylist(response: Response): Promise<void> {
    const status = response.status;
    let _headers: any = {};
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v));
   ...
   * @return OK
   */
  updateListById(body: UpdateVocabularyListDto | undefined): Promise<VocabularyListDtoApiResponse> {
    let url_ = this.baseUrl + "/api/VocabularyLists/update-list-by-id";
    url_ = url_.replace(/[?&]$/, "");
    ...
    return this.transformOptions(options_)
      ...
      .then((_response: Response) => {
        return this.processUpdateListById(_response);
      });
  }

  protected processUpdateListById(response: Response): Promise<VocabularyListDtoApiResponse> {
    const status = response.status;
    let _headers: any = {};
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v));
   ...
   * @return OK
   */
  deleteListById(listId: string): Promise<VocabularyListDtoApiResponse> {
    let url_ = this.baseUrl + "/api/VocabularyLists/delete-list-by-id/{listId}";
    if (listId === undefined || listId === null)
      throw new globalThis.Error("The parameter 'listId' must be defined.");
    url_ = url_.replace("{listId}", encodeURIComponent("" + listId));
    url_ = url_.replace(/[?&]$/, "");
    ...
    return this.transformOptions(options_)
      ...
      .then((_response: Response) => {
        return this.processDeleteListById(_response);
      });
  }

  protected processDeleteListById(response: Response): Promise<VocabularyListDtoApiResponse> {
    const status = response.status;
    let _headers: any = {};
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v));
